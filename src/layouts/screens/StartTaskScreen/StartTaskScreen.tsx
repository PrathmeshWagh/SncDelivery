                ...
                <ScrollView>
                    ...
                    <View style={{ backgroundColor: 'white' }}>
                        ...
                        {showCalendarPicker ? (
                            ...
                            <View style={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
                                <Pressable onPress={handleSubmit}>
                                    <IonIcon name="calendar-outline" size={36} color={Colors.brand_primary} style={styles.calendarIcon} />
                                    <Text style={{ color: Colors.brand_primary, fontSize: 18 }}>{translations.inventory_list.Open_Calendar}</Text>
                                </Pressable>
                            </View>
                        )}
                        {showCalendarPicker && (
                        ...
                        <View style={styles.inventoryView}>
                            ...
                            {isLoading ?
                                <ActivityIndicator size="large" color={Colors.brand_primary} style={{ marginVertical: 50, alignSelf: 'center' }} />
                                :
