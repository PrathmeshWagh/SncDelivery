            ...
            <ScrollView>
                <View style={styles.containerr}>
                            ...
                            <View>
                                ...
                                <View style={{ backgroundColor: '#E3E3E3', paddingTop: 10, paddingLeft: 10 }}>
                                    ...
                                    <RadioButton.Group onValueChange={handleRadioButtonChange} value={checked}>
                                        <RadioButton.Item label="Payment With QR Code" value="pay_now" color={Colors.brand_primary} labelStyle={{ color: '#515151' }} />
                                        <RadioButton.Item label="Cash" value="cash" color={Colors.brand_primary} labelStyle={{ color: '#515151' }} />
                                    </RadioButton.Group>
                                </View>
                                {showQRCode && (
                                ...
                                <View style={styles.align}>
                                    <Text style={styles.heading}>{translations.payment_confirmed.payment_proof}</Text>
                    ...
                    <View
                        ...
                        <Pressable
                            style={{
                                backgroundColor:Colors.brand_primary, // Change the background color when loading
                                padding: 10,
                                width: width * 0.34,
                                borderRadius: 7,
                            }}
