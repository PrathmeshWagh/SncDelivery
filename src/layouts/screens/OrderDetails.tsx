                        ...
                        <ScrollView>
                            <View style={styles.custDetailView}>
                                ...
                                <View style={styles.custDetail}>
                                    ...
                                    <View style={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
                                        ...
                                        <Text style={{
                                            fontSize: width * 0.03, color: Colors.brand_primary,
                                        }}>{oderDetails.email}</Text>
                                    </View>
                            ...
                            <View style={styles.custDetailView}>
                                <View style={styles.addressView}>
                                    <IonIcon name="location-outline" size={20} color={Colors.brand_primary} />
                                    <Text style={styles.addressViewText}>{oderDetails.address}, {oderDetails.unit_no}</Text>
                                </View>
                                <View style={styles.addressView}>
                                    <IonIcon name="calendar-outline" size={18} color={Colors.brand_primary} />
                                ...
                                <View style={styles.direction}>
                                    <Pressable style={styles.direction} onPress={() => openGoogleMapsDirections(
                                        ...
                                        <MaterialCommunityIcons name="directions" size={width * 0.05} color={Colors.brand_primary} />
                                        <Text style={{ fontSize: width * 0.03, color: Colors.brand_primary, marginLeft: 3 }}>
                            ...
                            <View style={styles.orderView}>
                                <View style={styles.ord}>
                                    ...
                                    <View style={styles.ord}>
                                        ...
                                        <Text style={{color: Colors.brand_primary, marginLeft: 10, fontSize: width * 0.03 }}>{oderDetails.consolidate_order_no}</Text>
                                    </View>
                                </View>
                                    ...
                                    {oderDetails.order_detail.map((product, index) => (
                                        <View key={index} style={{ display: 'flex', flexDirection: 'row', justifyContent: 'space-between', alignContent: 'center', marginBottom: 25 }}>
                                            ...
                                            <View style={{ display: 'flex', alignContent: 'center', justifyContent: 'center', width: '50%' }}>
                                                ...
                                                <Text style={{color: Colors.brand_primary, fontSize: width * 0.04 }}>{translations.order_details.Qty}: {product.quantity}</Text>
                                            </View>
