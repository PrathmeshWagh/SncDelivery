    ...
    return (
        <View style={styles.container}>
            <SwipeRefresh onRefresh={onRefresh} refreshing={refreshing}>
                {isLoading ? (
                    <ActivityIndicator style={styles.loader} size="large" color={Colors.brand_primary} />
                ) : (
                    <ScrollView>
                            ...
                            <View style={{ width: '90%', marginLeft: '5%', }}>
                                ...
                                <View style={styles.detailedView}>
                                    ...
                                    <View style={styles.rowView}>
                                        ...
                                        {/* <Text style={styles.detailedText}>
                                            {oder.payment_type === 'cash_on_delivery' ? 'COD' :
                                                oder.payment_type === 'pay_now' ? 'Pay Now' :
                                                    oder.payment_type === 'hitpay' ? 'HitPay' :
