...
import { useDispatch, useSelector as localUseSelector, useSelector } from 'react-redux'; // Rename the import
                                ...
                                <View style={styles.language}>
                                    <Pressable onPress={toggleModal} style={{ display: 'flex', flexDirection: 'row' }}>
                                        ...
                                        <Text style={{ color: 'white', marginLeft: 5, fontSize: width * 0.04, marginRight: 15 }}>
                                            {selectedLanguage === 'english' ? 'ZH' : 'EN'}
                                        </Text>
                                    </Pressable>
                                </View>
                            </View>
                ...
                <View style={styles.modalContent} >
                    ...
                    <View>
                        <RadioButton.Group
                            ...
                            <RadioButton.Item label="English" value="english" color={Colors.brand_primary} labelStyle={{ color: 'black' }} />
                            <RadioButton.Item label="Chinese" value="chinese"color={Colors.brand_primary}labelStyle={{ color: 'black' }} />
                        </RadioButton.Group>
                    </View>
