...
const CustomTopTabBar = ({ state, navigation, descriptors, date, toggleModal, selectedLanguage }: any) => {
    ...
    const formattedDate = moment(date).format("Do MMMM dddd YYYY");
        ...
        <>
            <View style={{ backgroundColor: 'white' }}>
                ...
                <View style={styles.amountPrice}>
                    <Text style={{ color:Colors.brand_primary, fontSize: width * 0.038, }}>{translations.order_listing.Collected_Cash}:
                        {loading ?
                            (
